...
import com.demo.thanhbv.demo.model.Employee;
...
public class WebController {
    ...
    public  ResponseEntity getListEp(){
        List<StudentEntity> data = studentService.GetAll();
    ...
    public ResponseEntity createEp(@RequestBody StudentEntity input){
    ...
    public  ResponseEntity updateEp(@RequestBody StudentEntity input){
        return  ResponseEntity.ok(studentService.UpdateStudentInfo(input));
    }

    @PostMapping("/deleteEmployee")
    public ResponseEntity deleteEp(@RequestParam int id){
